...
return [
	...
	*/
	...
	'custom' => [
		'email' => [
			'exists'           => 'Sorry, we couldn\'t find an account associated with this email address.',
		...
		'password' => [
			...
			'required_with' => 'The current password field is required when changing the password.',
		...
		'remember' => [
			'required' => 'Remember me option is invalid.',
		],
		'token' => [
